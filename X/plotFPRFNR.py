...
FPR_FNR_sex_df = pd.read_csv('/home/qwe/data/cuihaihang/lyn/X2/results/Subgroun_FNR_FPR_Sex.csv')
FPR_FNR_Age_df = pd.read_csv('/home/qwe/data/cuihaihang/lyn/X2/results/Subgroun_FNR_FPR_Age.csv')
...
def PlotSubgroup(Param, my_colors, NotEnough=False):
    ...
    plt.savefig('/home/qwe/data/cuihaihang/lyn/X2/results/FPRFNR/' + Param + '_NF.jpg', bbox_inches='tight')
...
#
# want = pd.read_csv('/home/qwe/data/cuihaihang/lyn/X2/results/Inter_FPFN_AgeSex.csv')
#
...
#     #     ticklabel.set_color(tickcolor)
#
#     plt.savefig('/home/qwe/data/cuihaihang/lyn/X2/results/FPRFNR/Int_' + param + '.jpg', bbox_inches='tight')
#
