...
def PlotLearnignCurve():
    print('start to plot')
    LrCurv_param = pd.read_csv('/home/qwe/data/cuihaihang/lyn/X_test/4/results_d121/Saved_items.csv')
    ...
    plt.savefig('/home/qwe/data/cuihaihang/lyn/X_test/4/results_d121/epoch_losses.png')
