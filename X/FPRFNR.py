...
def FPFN_NF_Covid(TrueWithMeta_df, df, diseases, category, category_name):
    ...
    for i in range(len(FN_total)):
        ...
        if category_name == 'Sex':
            ...
            FPR_sex.to_csv("/home/qwe/data/cuihaihang/lyn/X2/results/FPRFNR_NF_sex.csv")
        ...
        if category_name == 'Age':
            ...
            if i == 4:
                ...
                FPR_age = pd.concat([FPR_age, FNR_A.reindex(FPR_age.index)], axis=1)
            FPR_age.to_csv("/home/qwe/data/cuihaihang/lyn/X2/results/FPRFNR_NF_age.csv")
...
def FPFN_NF_Covid_Inter(TrueWithMeta_df, df, diseases, category1, category_name1, category2, category_name2):
    ...
    if (category_name1 == 'Sex') & (category_name2 == 'Age'):
        FP_AgeSex.to_csv("/home/qwe/data/cuihaihang/lyn/X2/results/FPFN_AgeSex.csv")
...
def FP_NF_Covid_MEMBERSHIP_Num_Inter0(TrueWithMeta_df, df, diseases, category1, category_name1, category2,
    ...
    if (category_name1 == 'Sex') & (category_name2 == 'Age'):
        FP_AgeSex.to_csv("/home/qwe/data/cuihaihang/lyn/X2/results/Num_NNF_AgeSex.csv")  # 所有没病的。0
...
def FN_NF_Covid_MEMBERSHIP_Num_Inter1(TrueWithMeta_df, df, diseases, category1, category_name1, category2,
    ...
    if (category_name1 == 'Sex') & (category_name2 == 'Age'):
        FP_AgeSex.to_csv("/home/qwe/data/cuihaihang/lyn/X2/results/Num_PNF_AgeSex.csv")
...
def FPR_Underdiagnosis():
    ...
    pred = pd.read_csv("/home/qwe/data/cuihaihang/lyn/X2/results70/bipred.csv")
    TrueWithMeta = pd.read_csv("/home/qwe/data/cuihaihang/lyn/X2/True_withMeta.csv")
...
def preprocess():
    testTrue = pd.read_csv("/home/qwe/data/cuihaihang/lyn/X2/results70/testTrue.csv")
    new_test = pd.read_csv('/home/qwe/data/cuihaihang/lyn/X2/new_test.csv')

    metaData = {'Path': new_test['Path'], 'Sex': new_test['Sex'], 'Age': new_test['Age']}
    metaData = pd.DataFrame(metaData)

    True_withMeta = testTrue.merge(metaData, left_on="Path", right_on="Path")
    ...
    True_withMeta.to_csv('/home/qwe/data/cuihaihang/lyn/X2/True_withMeta.csv')
