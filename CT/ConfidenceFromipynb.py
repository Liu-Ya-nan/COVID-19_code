...
FP5_age = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results/FPRFNR_NF_age.csv")
FP4_age = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results2/FPRFNR_NF_age.csv")
FP3_age = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results3/FPRFNR_NF_age.csv")
FP2_age = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results4/FPRFNR_NF_age.csv")
FP1_age = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results5/FPRFNR_NF_age.csv")
...
FPR_FNR_Age_df = FiveRunSubgroup(Age, FP_age_df, FPR_FNR_Age_df)
FPR_FNR_Age_df.to_csv('/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results_/Subgroun_FNR_FPR_Age.csv')


# 5个模型 2个性别平均 #NNF, FPR, CI_FPR, FNR, CI_FNR
FP5_sex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results/FPRFNR_NF_sex.csv")
FP4_sex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results2/FPRFNR_NF_sex.csv")
FP3_sex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results3/FPRFNR_NF_sex.csv")
FP2_sex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results4/FPRFNR_NF_sex.csv")
FP1_sex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results5/FPRFNR_NF_sex.csv")
...
FPR_FNR_sex_df.to_csv('/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results_/Subgroun_FNR_FPR_Sex.csv')


# 年龄性别交叉平均 FPR CI Num_NNF
FP5_agesex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results/FPFN_AgeSex.csv")
FP4_agesex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results2/FPFN_AgeSex.csv")
FP3_agesex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results3/FPFN_AgeSex.csv")
FP2_agesex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results4/FPFN_AgeSex.csv")
FP1_agesex = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results5/FPFN_AgeSex.csv")
...
Num_PNF_df = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results/Num_PNF_AgeSex.csv")   # 5个里面的这个文件内容都一样
Num_NNF_df = pd.read_csv("/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results/Num_NNF_AgeSex.csv")
...
want = FiveRun(factors1, factors2, AgeSex_df, FP_AgSx_df, Num_PNF_df, Num_NNF_df)
want.to_csv('/home/qwe/data/cuihaihang/lyn/CT3_nobalance/results_/Inter_FPFN_AgeSex.csv')
